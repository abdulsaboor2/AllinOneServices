...
declare type AnimatedViewProps = React.ComponentProps<Animated.AnimatedComponent<typeof View>>;
declare type ContainerStyleParam = ((translateYAnimatedValue: Animated.Value) => AnimatedViewProps['style']) | AnimatedViewProps['style'];
...
export declare type QueueMode = 'immediate' | 'next' | 'standby' | 'reset';
