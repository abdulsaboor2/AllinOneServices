    ...
    <ScrollView>
      <View style={{margin:5,padding:5}}>
        ...
        <Text style={{ textAlign: "justify" }}>
          Terms and Conditions for Public Help Serivice Introduction These
          Website Standard Terms and Conditions written on this webpage shall
        ...
        <Text style={{ textAlign: "justify" }}>
          ...
          all media. Your Content must be your own and must not be invading any
        ...
        <Text style={{ textAlign: "justify" }}>
          ...
          indemnify to the fullest extent Company Name from and against any
          ...
          provisions of these Terms. Severability If any provision of these
          Terms is found to be invalid under any applicable law, such provisions
          shall be deleted without affecting the remaining provisions herein.
          Variation of Terms Company Name is permitted to revise these Terms at
          any time as it sees fit, and by using this Website you are expected to
          review these Terms on a regular basis. Assignment The Company Name is
          ...
          and/or obligations under these Terms. Entire Agreement These Terms
          ...
          agreements and understandings. Governing Law and Jurisdiction These
